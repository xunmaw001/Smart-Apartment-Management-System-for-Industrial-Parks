...
var centerMenu = [
    ...
    ,{
        name: '缴费',
        url: '../jiaofei/list.html'
    }
    ,{
        name: '设施预约',
        url: '../sheshiyuyue/list.html'
    }
    ,{
        name: '维修报备',
        url: '../weixiubaobei/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/zhihuigongyuguanli/admin/dist/index.html#/login";
