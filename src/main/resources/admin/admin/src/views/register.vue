    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">产业园区智慧公寓管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="企业用户名称" class="input" v-if="tableName=='qiyeyonghu'">
                            <el-input v-model="ruleForm.qiyeyonghuName" autocomplete="off" placeholder="企业用户名称"  />
                        </el-form-item>
                        <el-form-item label="企业用户手机号" class="input" v-if="tableName=='qiyeyonghu'">
                            <el-input v-model="ruleForm.qiyeyonghuPhone" autocomplete="off" placeholder="企业用户手机号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="qiyeyonghuPhotoFlag">
                            </el-form-item>
                            <el-form-item label="企业用户头像" class="input" v-if="tableName=='qiyeyonghu'">
                                    <file-upload
                                        tip="点击上传企业用户头像"
                                        action="file/upload"
                                        :limit="1"
                                        :multiple="true"
                                        :fileUrls="ruleForm.qiyeyonghuPhoto?$base.url+ruleForm.qiyeyonghuPhoto:''"
                                        @change="qiyeyonghuPhotoUploadChange"
                                    ></file-upload>
                           </el-form-item>
                        -->
                        <el-form-item label="企业用户邮箱" class="input" v-if="tableName=='qiyeyonghu'">
                            <el-input v-model="ruleForm.qiyeyonghuEmail" autocomplete="off" placeholder="企业用户邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="逻辑删除" class="input" v-if="tableName=='qiyeyonghu'">
                                <el-input v-model="ruleForm.qiyeyonghuDelete" autocomplete="off" placeholder="逻辑删除"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="添加时间" class="input" v-if="tableName=='qiyeyonghu'">
                                <el-input v-model="ruleForm.insertTime" autocomplete="off" placeholder="添加时间"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='qiyeyonghu'">
    ...
    export default {
        data() {
            return {
                ...
                rules: {},
                sexTypesOptions : [],
                qiyeyonghuPhotoFlag:false,//用于刷新文件上传
        ...
        methods: {
            ...
            qiyeyonghuPhotoUploadChange(fileUrls) {
               this.ruleForm.qiyeyonghuPhoto = fileUrls;
                if(this.qiyeyonghuPhotoFlag){
                    this.qiyeyonghuPhotoFlag=false;
                }else{
                    this.qiyeyonghuPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            if((!this.ruleForm.qiyeyonghuName)&& 'qiyeyonghu'==this.tableName){
                                this.$message.error('企业用户名称不能为空');
                                return
                            }
                             if('qiyeyonghu' == this.tableName && this.ruleForm.qiyeyonghuPhone&&(!this.$validate.isMobile(this.ruleForm.qiyeyonghuPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            // qiyeyonghu 中的 企业用户头像 判空处理
                            // if('qiyeyonghu' == this.tableName && (this.ruleForm.qiyeyonghuPhoto== null ||this.ruleForm.qiyeyonghuPhoto== "")){
                            //     this.$message.error("企业用户头像不能为空");
                            //     return
                            // }
                            if('qiyeyonghu' == this.tableName && this.ruleForm.qiyeyonghuEmail&&(!this.$validate.isEmail(this.ruleForm.qiyeyonghuEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                            // qiyeyonghu 中的 逻辑删除 判空处理
                            // if('qiyeyonghu' == this.tableName && (this.ruleForm.qiyeyonghuDelete== null ||this.ruleForm.qiyeyonghuDelete== "")){
                            //     this.$message.error("逻辑删除不能为空");
                            //     return
                            // }
                            // qiyeyonghu 中的 添加时间 判空处理
                            // if('qiyeyonghu' == this.tableName && (this.ruleForm.insertTime== null ||this.ruleForm.insertTime== "")){
                            //     this.$message.error("添加时间不能为空");
                            //     return
                            // }
                            // qiyeyonghu 中的 创建时间 判空处理
                            // if('qiyeyonghu' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/zhihuigongyuguanli/img/back-img-bg.jpg);
