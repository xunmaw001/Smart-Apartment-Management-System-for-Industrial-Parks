<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='qiyeyonghu'"  label='企业用户名称' prop="qiyeyonghuName">
               <el-input v-model="ruleForm.qiyeyonghuName"  placeholder='企业用户名称' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='qiyeyonghu'"  label='企业用户手机号' prop="qiyeyonghuPhone">
               <el-input v-model="ruleForm.qiyeyonghuPhone"  placeholder='企业用户手机号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
             <el-form-item v-if="flag=='qiyeyonghu'" label='企业用户头像' prop="qiyeyonghuPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='qiyeyonghu'"  label='企业用户邮箱' prop="qiyeyonghuEmail">
               <el-input v-model="ruleForm.qiyeyonghuEmail"  placeholder='企业用户邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='qiyeyonghu'"  label='逻辑删除' prop="qiyeyonghuDelete">
               <el-input v-model="ruleForm.qiyeyonghuDelete"  placeholder='逻辑删除' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='逻辑删除' prop="yonghuDelete">
               <el-input v-model="ruleForm.yonghuDelete"  placeholder='逻辑删除' clearable></el-input>
           </el-form-item>
         </el-col>
...
|| flag=='qiyeyonghu')"  label="性别" prop="sexTypes">
...
// 注册表 企业用户 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.qiyeyonghuName)&& 'qiyeyonghu'==this.flag){
                             this.$message.error('企业用户名称不能为空');
                             return
                         }

                             if( 'qiyeyonghu' ==this.flag && this.ruleForm.qiyeyonghuPhone&&(!isMobile(this.ruleForm.qiyeyonghuPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.qiyeyonghuPhoto)&& 'qiyeyonghu'==this.flag){
                             this.$message.error('企业用户头像不能为空');
                             return
                         }

                             if( 'qiyeyonghu' ==this.flag && this.ruleForm.qiyeyonghuEmail&&(!isEmail(this.ruleForm.qiyeyonghuEmail))){
                                 this.$message.error(`邮箱应输入邮箱格式`);
                                 return
                             }
                         if((!this.ruleForm.qiyeyonghuDelete)&& 'qiyeyonghu'==this.flag){
                         ...
                         if((!this.ruleForm.yonghuDelete)&& 'yonghu'==this.flag){
                             this.$message.error('逻辑删除不能为空');
                             return
                         }

        if((!this.ruleForm.sexTypes) && (1==2|| this.flag=='yonghu'
|| this.flag=='qiyeyonghu')){
