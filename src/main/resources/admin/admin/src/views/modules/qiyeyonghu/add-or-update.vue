               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="企业用户名称" prop="qiyeyonghuName">
                       <el-input v-model="ruleForm.qiyeyonghuName"
                                 placeholder="企业用户名称" clearable  :readonly="ro.qiyeyonghuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="企业用户手机号" prop="qiyeyonghuPhone">
                       <el-input v-model="ruleForm.qiyeyonghuPhone"
                                 placeholder="企业用户手机号" clearable  :readonly="ro.qiyeyonghuPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="企业用户邮箱" prop="qiyeyonghuEmail">
                       <el-input v-model="ruleForm.qiyeyonghuEmail"
                                 placeholder="企业用户邮箱" clearable  :readonly="ro.qiyeyonghuEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    qiyeyonghuName: false,
                    qiyeyonghuPhone: false,
                    qiyeyonghuPhoto: false,
                    sexTypes: false,
                    qiyeyonghuEmail: false,
                    dataDelete: false,
                    insertTime: false,
                },
                ruleForm: {
                ...
                rules: {
                   ...
                   qiyeyonghuPhone: [
                              {  required: true, message: '企业用户手机号不能为空', trigger: 'blur' },
                   ...
                   qiyeyonghuPhoto: [
                              { required: true, message: '企业用户头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
                   ...
                   qiyeyonghuEmail: [
                              { required: true, message: '企业用户邮箱不能为空', trigger: 'blur' },
                              { pattern: /^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+/,
                                message: '企业用户邮箱只能是邮箱格式',
                                trigger: 'blur'
                              }
                          ],
                   dataDelete: [
