        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '缴费标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.jiaofeiName" placeholder="缴费标题" clearable></el-input>
                     </el-form-item>
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '缴费状态' : ''">
                        <el-select v-model="searchForm.zhuangtaiTypes" placeholder="请选择缴费状态">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zhihuigongyuguanli/upload/jiaofeiMuBan.xls"
                        >批量导入缴费数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('jiaofei','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="jiaofeiUuidNumber"
                                   header-align="center"
                                   label="缴费编号">
                        <template slot-scope="scope">
                            {{scope.row.jiaofeiUuidNumber}}
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="jiaofeiNewMoney"
                                   header-align="center"
                                   label="缴费金额">
                        <template slot-scope="scope">
                            {{scope.row.jiaofeiNewMoney}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="zhuangtaiTypes"
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            form:{
                id : null,
                jiaofeiUuidNumber : null,
                yonghuId : null,
                jiaofeiName : null,
                jiaofeiTypes : null,
                jiaofeiNewMoney : null,
                zhuangtaiTypes : null,
                insertTime : null,
                createTime : null,
            },
            ...
            json_fields: {
                //级联表字段
                     ...
                     '逻辑删除': 'yonghuDelete',
                //本表字段
                     '缴费编号': "jiaofeiUuidNumber",
                     '缴费标题': "jiaofeiName",
                     '缴费类型': "jiaofeiValue",
                     '缴费金额': "jiaofeiNewMoney",
                     '缴费状态': "zhuangtaiValue",
                     '录入时间': "insertTime",
            },
