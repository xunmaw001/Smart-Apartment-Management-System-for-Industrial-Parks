    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="缴费金额" prop="jiaofeiNewMoney">
                       <el-input v-model="ruleForm.jiaofeiNewMoney"
                                 placeholder="缴费金额" clearable  :readonly="ro.jiaofeiNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="缴费金额" prop="jiaofeiNewMoney">
                           <el-input v-model="ruleForm.jiaofeiNewMoney"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="缴费状态" prop="zhuangtaiTypes">
                        <el-select v-model="ruleForm.zhuangtaiTypes" :disabled="ro.zhuangtaiTypes" placeholder="请选择缴费状态">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="缴费状态" prop="zhuangtaiValue">
