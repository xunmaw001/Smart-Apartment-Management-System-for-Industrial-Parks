            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.qiyeyonghuId">
                            企业用户
                        </span>
...
|| (sessionTable == 'qiyeyonghu' && scope.row.qiyeyonghuId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zhihuigongyuguanli/upload/forumMuBan.xls"
                        >批量导入交流论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.qiyeyonghuId = el.qiyeyonghuId;//---
                            forum.qiyeyonghuName = el.qiyeyonghuName;
                            forum.qiyeyonghuPhone = el.qiyeyonghuPhone;
                            forum.qiyeyonghuPhoto = el.qiyeyonghuPhoto;
                            forum.qiyeyonghuEmail = el.qiyeyonghuEmail;
