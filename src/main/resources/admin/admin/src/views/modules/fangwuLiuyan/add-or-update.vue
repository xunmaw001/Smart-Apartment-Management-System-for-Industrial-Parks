    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="fangwuLiuyanText">
                        <el-input type="textarea"  :readonly="ro.fangwuLiuyanText" v-model="ruleForm.fangwuLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.fangwuLiuyanText" label="留言内容" prop="fangwuLiuyanText">
                            <span v-html="ruleForm.fangwuLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                ...
                this.ro.fangwuLiuyanText = true;//留言内容
            }else{
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`fangwuLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.fangwuLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
