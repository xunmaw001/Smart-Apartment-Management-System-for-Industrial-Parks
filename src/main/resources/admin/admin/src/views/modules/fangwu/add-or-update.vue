    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='qiyeyonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="逻辑删除" prop="qiyeyonghuDelete">
                        <el-input v-model="qiyeyonghuForm.qiyeyonghuDelete"
                                  placeholder="逻辑删除" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="逻辑删除" prop="qiyeyonghuDelete">
                            <el-input v-model="ruleForm.qiyeyonghuDelete"
            ...
            <input id="qiyeyonghuId" name="qiyeyonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="租金/月" prop="fangwuNewMoney">
                       <el-input v-model="ruleForm.fangwuNewMoney"
                                 placeholder="租金/月" clearable  :readonly="ro.fangwuNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="租金/月" prop="fangwuNewMoney">
                           <el-input v-model="ruleForm.fangwuNewMoney"
