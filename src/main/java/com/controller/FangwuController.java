    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(fangwu !=null){
            ...
            //级联表 企业用户
            //级联表
            QiyeyonghuEntity qiyeyonghu = qiyeyonghuService.selectById(fangwu.getQiyeyonghuId());
            if(qiyeyonghu != null){
    ...
    */
    ...
    public R save(@RequestBody FangwuEntity fangwu, HttpServletRequest request){
        ...
        if(false)
            ...
            fangwu.setQiyeyonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<FangwuEntity> queryWrapper = new EntityWrapper<FangwuEntity>()
            .eq("qiyeyonghu_id", fangwu.getQiyeyonghuId())
        ...
        if(fangwuEntity==null){
            ...
            fangwu.setFangwuClicknum(1);
            fangwu.setDataDelete(1);
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            FangwuEntity fangwuEntity = new FangwuEntity();
//                            fangwuEntity.setQiyeyonghuId(Integer.valueOf(data.get(0)));   //企业用户 要改的
...
//                            fangwuEntity.setFangwuClicknum(Integer.valueOf(data.get(0)));   //房屋热度 要改的
//                            fangwuEntity.setFangwuNewMoney(data.get(0));                    //租金/月 要改的
//                            fangwuEntity.setFangwuContent("");//详情和图片
//                            fangwuEntity.setDataDelete(1);//逻辑删除字段
...
//                            fangwuEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R gexingtuijian(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        params1.put("fangwuYesnoTypes",2);
        ...
        for(Integer type:typeList){
            ...
            params2.put("fangwuYesnoTypes",2);
    ...
    public R detail(@PathVariable("id") Integer id, HttpServletRequest request){
        ...
        FangwuEntity fangwu = fangwuService.selectById(id);
            if(fangwu !=null){
                ...
                //点击数量加1
                fangwu.setFangwuClicknum(fangwu.getFangwuClicknum()+1);
    ...
    */
    ...
    public R add(@RequestBody FangwuEntity fangwu, HttpServletRequest request){
        ...
        Wrapper<FangwuEntity> queryWrapper = new EntityWrapper<FangwuEntity>()
            ...
            .eq("cai_number", fangwu.getCaiNumber())
            .eq("fangwu_types", fangwu.getFangwuTypes())
            .eq("fangwu_clicknum", fangwu.getFangwuClicknum())
            .eq("data_delete", fangwu.getDataDelete())
