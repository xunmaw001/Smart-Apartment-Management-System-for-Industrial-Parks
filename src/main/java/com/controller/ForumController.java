    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            //级联表 企业用户
            //级联表
            QiyeyonghuEntity qiyeyonghu = qiyeyonghuService.selectById(forum.getQiyeyonghuId());
            if(qiyeyonghu != null){
            BeanUtils.copyProperties( qiyeyonghu , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "username", "password", "newMoney", "yonghuId"
, "qiyeyonghuId"
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setQiyeyonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("qiyeyonghu_id", forum.getQiyeyonghuId())
...
//                            forumEntity.setQiyeyonghuId(Integer.valueOf(data.get(0)));   //企业用户 要改的
